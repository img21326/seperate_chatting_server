...
func GetFacebookOAuthConfig() *oauth2.Config {
	return &oauth2.Config{
		...
		RedirectURL:  getEnv("Facebook_RedirectURL", "https://40f7-111-246-212-206.ngrok.io/oauth"),
...
func GetUserInfoFromFacebook(token string) (FacebookUserDetails, error) {
	...
	facebookUserDetailsRequest, _ := http.NewRequest("GET", "https://graph.facebook.com/me?fields=id,name,email,birthday&access_token="+token, nil)
